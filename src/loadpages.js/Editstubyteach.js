...
function Editstubyteach() {
  ...
  <Form>
    ...
    <Form.Group className="mb-3" controlId="formBasicName">
      ...
      <Form.Control type="text" placeholder="Enter Fullname" value={name} onChange={(e)=>setName(e.target.value)} disabled/>
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicClass">
      <Form.Label>Class</Form.Label>
      <Form.Control type="text" placeholder="Enter Class" value={cls} onChange={(e)=>setCls(e.target.value)} disabled/>
    </Form.Group>
    ...
    <Form.Group className="mb-3" controlId="formBasicCheckbox">
      <Form.Check type="checkbox" label="Check me for attendance (teachers only)" value={status} onChange={(e)=>setStatus(e.target.checked)} />
    </Form.Group>
    </div>
    <div className='col-6' style={{width:"500px"}}>
    <Profile />
    ...
    <Form.Group className="mb-3" controlId="formBasicName">
      ...
      <Form.Control type="text" placeholder="Enter Fullname" value={prtname} onChange={(e)=>setPrtname(e.target.value)} disabled/>
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicMobile">
      <Form.Label>Contact No.</Form.Label>
      <Form.Control type="number" placeholder="Enter Mobile.no" value={contact} onChange={(e)=>setContact(e.target.value)} disabled />
    </Form.Group>
    ...
    <Form.Group className="mb-3" controlId="formBasicAssign">
      ...
      <Form.Control type="number" value={assign} onChange={(e)=>setAssign(e.target.value)}/>
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicSubmit">
      <Form.Label>Submitted</Form.Label>
      <Form.Control type="number" value={done} onChange={(e)=>setDone(e.target.value)}/>
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicPending">
      <Form.Label>Pending</Form.Label>
      <Form.Control type="number" value={pending} onChange={(e)=>setPending(e.target.value)}/>
    </Form.Group>
    </div>
  </div>
  </Form>
